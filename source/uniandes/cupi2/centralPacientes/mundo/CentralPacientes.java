...
public class CentralPacientes
{
    ...
    /*
     * Da la cantidad de pacientes que se encuentran en la base de datos de pacientes
    ...
    /*
    public boolean darExistenPacienteGripa () {
        
        boolean ExGripa =false;
        Paciente actual = primero;
        ...
        */
    /*
     * Da la cantidad de pacientes con gripa en la base de datos
     * @return retorna la cantidad de pacientes con gripa
     * 
     */
    public int darCantidadPacienteConGripa() {
...
public int darCantidadMujeresConCovid () throws NoExisteException 
{
    int cantidad = 0;
    Paciente actual = primero;
    ...
    while (actual!= null)
    {
        if (actual.darSexo( )==2&& actual.darInformacionMedica( ).equals( "Covid" ))
        {
            cantidad++;
        }
    ...
    public boolean hayPacientesIngresadosEnClinica(String pClinicaUsuario) throws NoExisteException
    {
        ...
        {
            if (actual.darClinica( ).equals( pClinicaUsuario ))
            {
                existe = true;
            }
            actual = actual.darSiguiente( );
    ...
    {
        darCantidadPacientes( );
        
        return "Cantidad de pacientes: "+ darCantidadPacientes( );
    }

    /**
     * M�todo para la extensi�n2
     * @return retorna la cantidad de pacients con gripa
     */
    public String metodo2( )
    {
        darCantidadPacienteConGripa( );
        return "Cantidad de pacientes que padecen Gripa: "+ darCantidadPacienteConGripa( );
    }
...
public String metodo3 () 
{
 try
 {
     darCantidadMujeresConCovid();
     return "Hay " + darCantidadMujeresConCovid () + " Mujeres que fueron atendidad por la enfermedad Covid";
 }
 
 catch (NoExisteException e)
 {
     return " Se ha presentando el siguiente error"  + e.getMessage( );
 }
}
    ...
    {
        try {
            String Clinica = JOptionPane.showInputDialog( "Escriba la cl�nica a buscar" );
            hayPacientesIngresadosEnClinica(Clinica);
            if( hayPacientesIngresadosEnClinica(Clinica)!=true) {
                return"no existen pacientes ";
            }
            else {
                return "si existen pacientes ";
            }
        
        }catch(NoExisteException e) {
     
            return "Se ha presentado el siguiente error: "+e.getMessage( );
        }
